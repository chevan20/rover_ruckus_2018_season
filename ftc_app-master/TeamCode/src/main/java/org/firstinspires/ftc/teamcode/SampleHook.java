...
@Autonomous(name = "SampleHook", group = "test")
public class SampleHook extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (!isStopRequested()) {
            while (HookMotor.getCurrentPosition() < 12000 && !isStopRequested()) {
                HookMotor.setPower(1);
        ...
        while (!isStopRequested()) {
            ...
            if (Right && !isStopRequested()) {
                ...
                moveDistance(15);
                stop();
            } else if (Center && !isStopRequested()) {
                //----------------------------------------------------------------------------CENTER
                gyro.resetZAxisIntegrator();
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions.size() != 0) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            telemetry.addData("left", Left);
                            telemetry.addData("right", Right);
                            telemetry.addData("venter", Center);
                            telemetry.update();
                        }
                    }
                    telemetry.update();
